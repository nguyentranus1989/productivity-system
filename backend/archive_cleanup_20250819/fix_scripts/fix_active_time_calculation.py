#!/usr/bin/env python3
"""
Fix for calculate_active_time method in productivity_calculator.py
This ensures idle time at start and end of day is properly calculated
"""

# This is the fixed calculate_active_time method that should replace lines 44-122
...
# 1. Back up the original file (already done)
# 2. Open productivity_calculator.py
# 3. Find the calculate_active_time method (around line 44)
# 4. Replace the entire method with the code above
