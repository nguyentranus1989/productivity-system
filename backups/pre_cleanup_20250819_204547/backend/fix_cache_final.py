"""Fix cache decorator to work correctly with Flask endpoints"""
...
with open('/var/www/productivity-system/backend/simple_cache.py', 'w') as f:
    f.write(content)

print("✅ Fixed cache implementation")
