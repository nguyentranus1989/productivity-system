...
# Our fixed calculate_active_time method
...
# Find and replace ONLY the calculate_active_time method
# Updated pattern to properly match the method
pattern = r'(    def calculate_active_time\(self, activities: List\[Dict\], role_config = None\) -> int:.*?)((?=\n    def )|(?=\nclass )|$)'
...
if match:
    ...
    print("The file still has all other methods intact.")
else:
    print("ERROR: Could not find calculate_active_time method to replace")
